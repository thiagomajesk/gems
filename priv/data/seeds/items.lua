return {
  wood = {
    ...
    name = "Wood",
    code = "item_wood",
    type_id = "7471df3c-8da8-4565-a44b-67f953230cd6",
    tier = "t1",
  },
  red_herbs = {
    __order = 1,
  ...
  health_potion = {
    ...
    price = 5,
    type_id = "d8c1c8a8-6c7d-4f1a-9c8e-ff1c7a9f9e55",
    tier = "t1",
    target_side = "self",
    target_status = "alive",
    item_ingredients = {
      {
        amount = 1,
        ingredient_id = "54aa78b8-f8c2-455d-9738-d0f3b45ea0e1"
      },
      {
        amount = 2,
        ingredient_id = "4fa40ff7-f740-4392-a368-045cec0b7d1b"
      }
    }
  },
  energy_potion = {
    ...
    item_ingredients = {
      ...
      {
        amount = 2,
        ingredient_id = "6356bb96-4db3-40a4-8a3b-c3cd2486ab92"
      }
    }
  }
}
